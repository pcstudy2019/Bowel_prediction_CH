...
FEATURE_DETAILS = {
    ...
    'DietaryRestrictionDays': {'display': '饮食限制天数', 'type': 'slider', 'min': 0, 'max': 3, 'step': 0.5, 'default': 0.5},
...
FEATURE_DETAILS_EN = {
    ...
    'DietaryRestrictionDays': {'display': 'Dietary Restriction Days', 'type': 'slider', 'min': 0, 'max': 3, 'step': 0.5,'default': 0.5},
